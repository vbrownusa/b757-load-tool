...
def generate_release(data):
   ...
   ZONE_A = {
1:(199.8,199.8),2:(299.6,299.5),3:(499.3,499.3),4:(699.1,699.1),5:(798.9,898.9),
...
ZONE_B = {
1:(200.0,200.0),2:(299.9,299.9),3:(499.9,499.9),4:(699.8,699.8),5:(799.8,899.8),
...
ZONE_C = {
1:(200.1,200.2),2:(300.3,300.3),3:(500.4,500.5),4:(700.6,700.6),5:(800.7,900.8),
