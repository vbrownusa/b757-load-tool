...
with cols[0]:
    c1 = st.number_input("Bin 1", min_value=0, value=0, key="cargo1")
    c1_awu = cargo_awu_by_rule(CARGO_BIN1, c1)
    st.caption(f"AWU: {c1_awu:.1f}")

with cols[1]:
    c2 = st.number_input("Bin 2", min_value=0, value=0, key="cargo2")
    c2_awu = cargo_awu_by_rule(CARGO_BIN2, c2)
    st.caption(f"AWU: {c2_awu:.1f}")

with cols[2]:
    c3 = st.number_input("Bin 3", min_value=0, value=0, key="cargo3")
    c3_awu = cargo_awu_by_rule(CARGO_BIN3, c3)
    st.caption(f"AWU: {c3_awu:.1f}")

with cols[3]:
    c4 = st.number_input("Bin 4", min_value=0, value=0, key="cargo4")
    c4_awu = cargo_awu_by_rule(CARGO_BIN4, c4)
    st.caption(f"AWU: {c4_awu:.1f}")
